...
class GameMap:
    ...
    def make_map(self, max_rooms, room_min_size, room_max_size, map_width, 
        ...
        for r in range(max_rooms):
            ...
            for other_room in rooms:
                ...
                #this means there are no intersections, so this toom is valid

                # "paint" it to the map's tils
                ...
                if num_rooms == 0:
                    # this is the first room, where the player starts ar
                    player.x = new_x
                    player.y = new_y
                ...
                # finally, append the new room the the list
    ...
    def create_room(self, room):
        # go through the tiles in the tectangle and make them passable
    ...
    def place_entities(self, room, entities):
        ...
        for i in range(number_of_items):
            ...
            if not any([entity for entity in entities if entity.x == x and entity.y == y]):
                item:choice = random_choice_from_dict(item_chances)
